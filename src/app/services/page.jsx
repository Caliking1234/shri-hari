...
const Page = () => {
  ...
  return (
    <div className=" w-full relative">
      <div className=" z-[60] fixed bottom-2 left-0 md:top-[50%] md:-translate-y-[50%] w-full md:w-[100px] h-[80px] text-sm  flex items-center justify-center flex-row  md:flex-col gap-2">
        <Link
          href={"/contact"}
          className=" w-full bg-[#233976] text-center px-2 py-3 shadow-md shadow-black hover:shadow-lg hover:shadow-black hover:scale-95 transition-all duration-150"
        >
          Book An Appointment
        </Link>
        <Link
